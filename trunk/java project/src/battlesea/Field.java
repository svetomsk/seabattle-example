...
public class Field
    {
     ...
     private static final int SIZE = 10; //const used for size of the field
     private static final int s = 4;    //quantity of 1x1(small) ships
     private static final int m = 3;    //quantity of 1x2(medium) ships
     private static final int b = 2;    //quantity of 1x3(big) ships
